...
def welcome_message(name, course):
    ...
    return "welcome"+ name + "and" + course + "class"
...
def count_vowels_consonants(text):
    ...
    vowels = text.count('0') + text.count('1') + text.count('2') + text.count('3') + text.count('4') + text.count('5')+ text.count('6')+ text.count('7')+ text.count('8')+ text.count('9')
